...
__STATIC_INLINE uint8_t DAP_GetSerNumString (char *str)
{
	...
	SN  =  uid[0] & 0x0001FFFF;     //取前面0~16位,17位，对应唯一识别码0~16位
	SN |= (uid[0]>>28)<<17;         //取28到31位，4位 ，对应17-20
	SN |= (uid[1]&3)<<21;           //取32~33，2位，对应21~22
	SN |=((uid[2]>>15)&0x1ff)<<23;  //取最后9位,对应唯一识别码23~31
